...
import com.itnext.sendmail.SendMail;
...
public class RegisterServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(check==null)
            {
                out.println("box not checked \nPlease accept the term and conditioms...");
            }
            else
            {   
                ...
                // create users object and set all the data to that object
                User user=new User(name, phone, email, password, gender, about,code);
