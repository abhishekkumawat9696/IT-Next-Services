      ...
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_center">
            <h3>User List</h3>
            <p class="large">Users Who are registerd in IT Next.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="row">        
        <table class="table" style="margin-left:100px; margin-right: 100px;">
            ...
            <tr>
             ...
             <%
                          UserDao use=new UserDao(connectionProvider.getConnection());
                           ArrayList<User> list=use.getAllUsers();
                          for(User c:list)
                          {
                          %>
      ...
      <div class="modal-body">
         <form id="reply" class="table-form" name="table-form" method="POST" action="ContactReplyServlet">
          <div class="form-group">
              <input type="text" name="id" class="form-control" id="recipient-idR" style="border:none;" value="" disabled>
          </div>
          <div class="form-group">
              <input type="text" name="name" class="form-control" id="recipient-nameR" value="" required>
          </div>
          
          <div class="form-group">
              <input type="email" name="email" class="form-control" value="" id="recipient-emailR" required>
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <form id="delete" class="table-form" name="table-form" method="POST" action="ContactDeleteServlet">
          <div class="form-group">
              <input type="text" name="uid" class="form-control text-center" id="recipient-id1" style="border: none; font-size: 20px;" value="" required>
          </div>
          <div class="form-group">
        ...
        <script src="https://code.jquery.com/jquery-3.5.1.min.js"
            ...
            <script>
                $('.table tbody').on('click','.btn',function(){
                    ...
                    var result=col1+'\n'+col2+'\n'+col3+'\n'+col4+'\n';
                    document.getElementById("recipient-idR").value=col1;
                    document.getElementById("recipient-nameR").value=col2;
                    document.getElementById("recipient-emailR").value=col4;
